...
public class DealAdapter extends RecyclerView.Adapter<DealAdapter.DealViewHolder> {
    ...
    public DealAdapter() {
        ...
        eChildListener = new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                eDeals.add(td);
                notifyItemInserted(eDeals.size() - 1);
            }
        ...
        eDatabaseReference.addChildEventListener(eChildListener);
    }
    ...
    public void onBindViewHolder(@NonNull DealViewHolder holder, int position) {
        TravelDeal deal = eDeals.get(position);
        holder.bind(deal);
    }
    ...
    public class DealViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public DealViewHolder(@NonNull View itemView) {
            ...
            eImageDeal = itemView.findViewById(R.id.imageDeal);
...
//            showImage(deal.getImageUrl());
        ...
        public void onClick(View view) {
            ...
            TravelDeal selectedDeal = eDeals.get(position);
        ...
        private void showImage(String url) {
            if (url != null && !url.isEmpty()) {
                Picasso.get().load(url).resize(200, 200).centerCrop().into(eImageDeal);
            }
        }
    }
}
